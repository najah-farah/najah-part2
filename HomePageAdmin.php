...
<!-- webpage content goes here in the body -->
	...
	<div id="page">
		...
		<div>
				...
				<a href="HomePageAdmin.php">About |</a>
				<a href="HomePageAdmin.php">Contact |</a>
				<a href="HomePageAdmin.php">Manage |</a>
				<a href="AdminRequest.php">Request |</a>
